...
/////////////////////////////////////////////////////////////////////////////
//螢幕比例調成20:9(手機規格)
#define SIZE_X				 640//640		// 設定遊戲畫面的解析度為640x480
#define SIZE_Y				 480//480		// 註：若不使用標準的解析度，則不能切換到全螢幕
...
private:
	...
	static void  LoadBitmap(int i, int BITMAP);
...
public:
	...
	void  LoadBitmap(char *,COLORREF=CLR_INVALID);	// 載入圖，ㄡ指定圖的檔名及透明色
